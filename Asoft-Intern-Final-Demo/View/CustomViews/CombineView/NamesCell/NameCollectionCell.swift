...
extension NameCollectionCell: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        (cell.viewWithTag(2) as! UILabel).text = self.detailCombines[indexPath.section][indexPath.row].name
        (cell.viewWithTag(3) as! UILabel).text = self.detailCombines[indexPath.section][indexPath.row].detailName
