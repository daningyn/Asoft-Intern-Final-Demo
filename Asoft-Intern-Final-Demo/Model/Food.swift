...
class Food {
    ...
    init(id: String, name: String, image: String, timeToPerform: Int, type: String, cookingType: [String], videoLink: String, favorite: Bool, ingridientHeader: [String], ingridientDetail: [[String]], directionHeader: [String], directionDetail: [[String]]) {
        self.id = id
        self.name = name
        self.image = image
