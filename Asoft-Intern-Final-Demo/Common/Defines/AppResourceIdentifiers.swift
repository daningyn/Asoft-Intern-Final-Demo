...
class AppResourceIdentifiers {
    ...
    static let kRecipeChoosenTextTableViewCellArray = [["2 teaspoons canola oil", "4 cloves of smashed garlic", "2 sticks unsalted butter", "2 loaves good guality Pullman"], ["2 teaspoons canola oil", "4 cloves of smashed garlic", "2 sticks unsalted butter", "2 loaves good guality Pullman"]]
    static let kRecipeChoosenTextTableViewHeaderArray = ["Grilled Texas Toast", "Pickled Red Onions"]
